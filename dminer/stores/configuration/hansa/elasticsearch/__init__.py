...
instance, create an index template for use with the hansa ingestion module,
...
def prepare_cli(parser):
    ...
    hansa elasticsearch configuration module. It also sets the entry point
...
def entry(arguments):
    ...
    config = HansaElasticsearchConfiguration(
