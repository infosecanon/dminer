...
instance, create an index template for use with the dreammarket ingestion module,
...
def prepare_cli(parser):
    ...
    dreammarket elasticsearch configuration module. It also sets the entry point
